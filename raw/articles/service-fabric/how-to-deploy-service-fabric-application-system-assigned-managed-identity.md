...
> [!NOTE] 
> Enabling identity for an existing app that was initially deployed using Azure cmdlets isn't supported.
...
* Use a Service Fabric application's [managed identity from source code](./how-to-managed-identity-service-fabric-app-code.md)
