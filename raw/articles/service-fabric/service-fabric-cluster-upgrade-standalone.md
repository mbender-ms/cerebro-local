...
Make sure that your cluster always runs a [supported Service Fabric version](service-fabric-versions.md). When Microsoft announces the release of a new version of Service Fabric, the previous version is marked for end of support after a minimum of 60 days from the date of the announcement. New releases are announced [on the Service Fabric team blog](https://azure.microsoft.com/blog/product/azure-service-fabric/). The new release is available to choose at that point.
