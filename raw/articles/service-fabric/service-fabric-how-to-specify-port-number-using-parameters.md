...
ms.date: 03/22/2026
# Customer intent: "As a developer, I want to specify the port number for my Service Fabric application using parameters, so that I can easily configure it for different environments during deployment."
---
