...
Replicator configurations configure the replicator that's responsible for making the stateful Reliable Service's state highly reliable by replicating and persisting the state locally.
