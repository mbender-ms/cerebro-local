...
ms.date: 03/22/2026
# Customer intent: As an application developer, I want to understand the XML schema for the Service Fabric service model, so that I can effectively create and manage my services within the Service Fabric environment.
---
