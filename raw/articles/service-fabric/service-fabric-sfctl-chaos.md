...
If Chaos isn't already running in the cluster, it starts Chaos with the passed in Chaos parameters. If Chaos is already running when this call is made, the call fails with the error code FABRIC_E_CHAOS_ALREADY_RUNNING. For more details, see [Induce controlled Chaos in Service Fabric clusters](service-fabric-controlled-chaos.md).
