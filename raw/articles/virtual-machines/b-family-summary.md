...
# Customer intent: As a cloud architect, I want to understand the B family of VM size series, so that I can assess their CPU credit model for optimizing cost and performance in my virtual machine deployments.
---
