---
title: Use a VHD snapshot to create multiple identical managed disks (Windows) - PowerShell
...
# Create multiple identical managed disks using a VHD snapshot in a storage account with PowerShell (Windows)
