...
1. On the **Create an Azure Cosmos DB account** page, select the **Create** option within the **Azure Cosmos DB for NoSQL** section.
   ...
   To learn more about the API for NoSQL, see [Welcome to Azure Cosmos DB](/azure/cosmos-db/introduction).
...
1. In the **Create Azure Cosmos DB Account** page, enter the basic settings for the new Azure Cosmos DB account.
   ...
   :::image type="content" source="../../../media/cosmos-db/azure-cosmos-db-create-new-account-detail.png" alt-text="Screenshot shows the Create Azure Cosmos DB Account page." lightbox="../../../media/cosmos-db/azure-cosmos-db-create-new-account-detail.png":::
...
1. Optionally, you can configure more details in the following tabs:
   ...
   - **Networking**. Configure [access from a virtual network](/azure/cosmos-db/how-to-configure-vnet-service-endpoint).
   - **Backup Policy**. Configure either [periodic](/azure/cosmos-db/periodic-backup-restore-introduction) or [continuous](/azure/cosmos-db/provision-account-continuous-backup) backup policy.
   - **Encryption**. Use either service-managed key or a [customer-managed key](/azure/cosmos-db/how-to-setup-cmk#create-a-new-azure-cosmos-account).
...
1. Review the account settings, and then select **Create**. It takes a few minutes to create the account. Wait for the portal page to display **Your deployment is complete**.
   ...
   :::image type="content" source="../../../media/cosmos-db/azure-cosmos-db-account-created.png" alt-text="Screenshot shows that your deployment is complete." lightbox="../../../media/cosmos-db/azure-cosmos-db-account-created.png":::

1. Select **Go to resource** to go to the Azure Cosmos DB account page.

   :::image type="content" source="../../../media/cosmos-db/azure-cosmos-db-account-created-2.png" alt-text="Screenshot shows the Azure Cosmos DB account page." lightbox="../../../media/cosmos-db/azure-cosmos-db-account-created-2.png":::
