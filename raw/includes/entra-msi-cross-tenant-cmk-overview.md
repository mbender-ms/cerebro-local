...
- In the service provider tenant, it isn't possible to automate the [Publisher Verification](/azure/active-directory/develop/publisher-verification-overview).
