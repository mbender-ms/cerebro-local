...
| [WVDMultiLinkAdd](/azure/azure-monitor/reference/tables/WVDMultiLinkAdd)<p>Azure Virtual Desktop MultiLink Add Activity. | windowsvirtualdesktop | LogManagement | No| -|
