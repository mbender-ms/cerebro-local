...
|**Egress**<br><br>The amount of Egress data, in bytes. |`Egress` |Bytes |Total (Sum) |`OutputFormat`|PT1M |Yes|
...
|**Requests**<br><br>Requests to a Streaming Endpoint. |`Requests` |Count |Total (Sum) |`OutputFormat`, `HttpStatusCode`, `ErrorCode`|PT1M |Yes|
