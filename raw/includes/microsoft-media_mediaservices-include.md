...
| [AMSMediaAccountHealth](/azure/azure-monitor/reference/tables/AMSMediaAccountHealth)<p>Media Account Health Status. This table captures the Azure Media Services account health status. It can be used to diagnose issues for unhealthy accounts. | audit, resources | LogManagement | Yes| [Yes](/azure/azure-monitor/reference/queries/amsmediaaccounthealth)|
