...
|---|---|---|---|---|---|---|
|**Byte Count**<br><br>Total number of Bytes transmitted within time period |`ByteCount` |Bytes |Total (Sum) |`Port`, `Direction`|PT1M |Yes|
...
|**Packet Count**<br><br>Total number of Packets transmitted within time period |`PacketCount` |Count |Total (Sum) |`Port`, `Direction`|PT1M |Yes|
...
|**SYN Count**<br><br>Total number of SYN Packets transmitted within time period |`SynCount` |Count |Total (Sum) |`Port`, `Direction`|PT1M |Yes|
