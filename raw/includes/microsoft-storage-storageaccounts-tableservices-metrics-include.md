...
|---|---|---|---|---|---|---|
|**Table Capacity**<br><br>The amount of Table storage used by the storage account. |`TableCapacity` |Bytes |Average |\<none\>|PT1H |Yes|
|**Table Count**<br><br>The number of tables in the storage account. |`TableCount` |Count |Average |\<none\>|PT1H |Yes|
|**Table Entity Count**<br><br>The number of table entities in the storage account. |`TableEntityCount` |Count |Average |\<none\>|PT1H |Yes|
