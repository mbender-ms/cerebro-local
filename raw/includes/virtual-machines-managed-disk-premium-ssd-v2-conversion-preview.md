...
---
> [!NOTE]
> You can change the type of an existing disk to a Premium SSD v2 the same way you would for other disk types. To learn about the feature see [Premium SSD v2 migration](#convert-premium-ssd-v2-disks).